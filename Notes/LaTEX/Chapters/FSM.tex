...
\subsection{Matematikai megközelítés}
...
Egy egyszerű példa egy ajtó nyitására, nyitva tartására és csukására, amit Georges Ltief papírjából\cite{Georges2024} szereztem.\\
...
\subsection{Programozói megközelítés}
\label{subsec:Prog}
